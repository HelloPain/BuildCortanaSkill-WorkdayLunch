...
static class PublicData//the Encapsulation of all providers' databases
{
    ...
    public static class Table_Restaurants//may need update
    {
        ...
        public class Restaurant
        {
            ...
            protected internal bool is_delivering;
            ...
            private double average_cost_by_one;//decimal(7,2)
            protected internal bool is_average_cost_by_one_init = false;
            private double average_cost_by_two;//two persions;decimal(7,2)
    ...
    public static class Table_RatingComments//may need frequent update
    {
        ...
        public const string Columns = "([ID],[rating],[user_name],[user_level],[likes],[comment],[nationID],[DataProviderID])";
        public class RatingComment
        {
            public RatingComment(TinyInt rating)
            {
                Rating = rating;
            }
    ...
    //   DishRating: doesn't affect the behavior of the method, only used to distinguish overloads
    //
    // Return:
    ...
    public static async Task<BigInt> AddRatingCommentAsync(SqlConnection connection, SmallInt resID, Table_RatingComments.RatingComment rat)
    {
        ...
        string insertionCommandString = "INSERT INTO" + DatabaseHeader + Table_RatingComments.Header + Table_RatingComments.Columns
            + "VALUES(@id,@rating,@userName,@userLevel,@likes,@comment,@nationID,@providerID)";
        using (SqlCommand Insertion = new SqlCommand(insertionCommandString, connection))
        {
            ...
            if (rat.is_likes_init) Insertion.Parameters.AddWithValue("@likes", rat.Likes);
            else Insertion.Parameters.AddWithValue("@likes", DBNull.Value);
    ...
    public static async Task<BigInt> AddRatingCommentAsync(SqlConnection connection, BigInt dishID, bool DishRating, Table_RatingComments.RatingComment rat)
    {
        Task<BigInt> newID = GenerateNewRatingCommentID(connection);
        string insertionCommandString = "INSERT INTO" + DatabaseHeader + Table_RatingComments.Header + Table_RatingComments.Columns
            + "VALUES(@id,@rating,@userName,@userLevel,@likes,@comment,@nationID,@providerID)";
